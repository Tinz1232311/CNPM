    ...
    <style>
        * {
        ...
        .button-group .google-button {
            width: calc(100% + 10px); /* Bằng tổng chiều rộng của Login và Register cộng với khoảng trắng giữa */
            padding: 10px;
            background: linear-gradient(to right, #ff7eb3, #ff758c);
            color: white;
            border: none;
        ...
        .button-group .login-button:hover,
        .button-group .register-button:hover,
        .button-group .google-button:hover {
            background: linear-gradient(to right, #ff5473, #ff758c);
        ...
        /* Style for the link to forgot password */
...
<body>
    <div class="page">
        <form action="/FruitShop/LoginServer" method="post" class="login-frame">
            <h2>Login</h2>
